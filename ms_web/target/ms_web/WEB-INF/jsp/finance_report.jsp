    ...
    <form id="editForm" method="post">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-md-4">
                <button style="background-color: rgba(0, 204, 102, .6);border-color: rgba(0, 204, 102, .9); color: #ffffff;
width: 100px; height: 35px; margin-left: 100px; margin-top: -16px;"><a href="export_report" style="color: #ffffff;">导&nbsp;出&nbsp;报&nbsp;表</a></button>
            </div>
        </div>
    ...
    <table class="table table-hover table-bordered">
        ...
        <c:forEach items="${pageInfo.list}" var="employee">
            <tr style="background-color: rgba(242,242,242, .4);">
                ...
                <th id="reportName">${employee.reportName}</th>
                <th id="cost">${employee.cost}</th>
                <th id="price">${employee.price}</th>
                <th id="profit">${employee.profit}</th>
                <th id="taxProfit">${employee.taxProfit}</th>
            </tr>
        </c:forEach>
        </thead>
    </table>
